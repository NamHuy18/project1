...
<div class="line"></div>
<div class="wrapper">
    {!! Form::open(['method' => 'POST', 'route' => ['addSale']]) !!}
        <fieldset>
            <div class="widget">
                <div class="title">
                ...
                <div class="formRow">                  
                    ...
                    <div class="formRight">                      
                        <span class="oneTwo">{!! Form::text('discount') !!}</span>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">                  
                    ...
                    <div class="formRight">                      
                        {!! Form::text('start_date', null, ['id' => 'datepicker']) !!}
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">                  
                    ...
                    <div class="formRight">                      
                            {!! Form::text('end_date', null, ['id' => 'datepicker1']) !!}
                    </div>
                    <div class="clear"></div>
                </div>
